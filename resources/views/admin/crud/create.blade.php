...
@section('title', Str::ucfrist($modelName).' | Crear')
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                {{ Form::open(['url' => $formUrl, 'files' => true]) }}
                    <div class="card-header">
                        <strong>{{ Str::ucfrist($modelName) }}</strong>
                    </div>
                    <div class="card-body">

                        @foreach($iattributes as $attribute)
